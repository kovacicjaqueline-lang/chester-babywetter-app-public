      ...
      <div class="sheet trip-sheet">
        ...
        <div id="tripBuilderView">
          ...
          <section class="trip-builder-section" aria-labelledby="tripSegmentsHeading">
            <div class="trip-section-heading"><h3 id="tripSegmentsHeading">2. Situationen im Tagesverlauf</h3><button id="tripAddSegmentButton" class="trip-add-button" type="button">+ Wechsel hinzufügen</button></div>
